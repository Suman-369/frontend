...
const StudentDashboard = () => {
  ...
  const sidebarLinks = [
    ...
    { name: 'My Room', path: '/student/myroom', icon: BedDouble },
    { name: 'Complaints', path: '/student/complaints', icon: AlertCircle },
    { name: 'Vacancy', path: '/student/vacancy', icon: DoorOpen },
  ];

  const settingLinks = [
    { name: 'Profile', path: '#', icon: User },
    { name: 'Setting', path: '#', icon: Settings },
          ...
          {!isCollapsed && (
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-white tracking-tight whitespace-nowrap">
                Hostel<span className="text-[#FFB800]">Hub</span>
              </h1>
            </div>
          )}
          <div className="flex items-center">
